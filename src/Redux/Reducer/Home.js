...
export default (state = initialstate, action) => {
  switch (action.type) {
    ...
    case 'Search_Retailer_Success':
      return { ...state, isFetching: false, SearchRetailerList: action.payload, data2: action.data2 };
    ...
    case 'product_TypeList_Success':
      return { ...state, isFetching: false, productTypeList: action.payload, session: action.session };
