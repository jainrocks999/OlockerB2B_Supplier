  ...
  return (
    <View style={{flex: 1, backgroundColor: 'white'}}>
      <ScrollView contentContainerStyle={{}}>
          ...
          <View style={{marginHorizontal: 15, marginTop: 20}}>
            <Text style={{fontSize: 21, fontWeight: '800', color: '#000'}}>
              ...
              <Text style={{fontSize: 18}}>
                (DETAILS OF DIAMOND USED IN PRODUCT)
              </Text>
            </Text>
          </View>
          ...
          <View style={styles.Card}>
            <View
              ...
              <View
                ...
                <Text style={{fontWeight: '600', fontSize: 18}}>Diamond Name</Text>
            ...
            <View
              ...
              <View
                ...
                <Text style={{fontWeight: '600', fontSize: 18}}>Diamond Wt.</Text>
                <Text style={{fontWeight: '600', fontSize: 18}}>:</Text>
              </View>
            ...
            <View
              ...
              <View
                ...
                <Text style={{fontWeight: '600', fontSize: 18}}>Unit of Diamond Wt.</Text>
                <Text style={{fontWeight: '600', fontSize: 18}}>:</Text>
              </View>
              <View style={{width: '41.5%'}}>
            ...
            <View
              ...
              <View style={{width: '41.5%'}}>
                <Text style={{fontWeight: '500', fontSize: 18}}>SFFG</Text>
              </View>
            </View>
            <View
              style={{
              ...
              <View style={{width: '41.5%'}}>
                <Text style={{fontWeight: '500', fontSize: 18}}>Marquis Cut</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <TouchableOpacity
          style={styles.addbtn}>
          <Text style={{fontSize: 18, color: 'white'}}>Add Diamond Details</Text>
        </TouchableOpacity>
      </ScrollView>
