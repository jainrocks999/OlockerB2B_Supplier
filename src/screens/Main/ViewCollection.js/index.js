      ...
      <View style={{flex: 1, backgroundColor: 'white'}}>
        ...
        <View style={styles.container}>
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            ...
            <Text style={[styles.text, {marginLeft: 15}]}>View Collection</Text>
          </View>
        ...
        <View style={{ marginTop: 20}}>
          <View style={{padding: 10, borderRadius: 10}}>
            <Image
              ...
              source={{
                uri: 'https://t4.ftcdn.net/jpg/00/62/65/29/360_F_62652907_dZgAPIdcVKu8DPCeUPvLRCb9JdHrnpVG.jpg',
              }}
            />
          </View>
          <View style={{marginHorizontal: 30, marginTop: 15}}>
            <Text style={{fontSize: 20, fontWeight: '700'}}>Loream Loream</Text>
            <Text style={{fontSize: 16, fontWeight: '700'}}>Loream Loream</Text>
          </View>
          ...
          <View
            ...
            <View
              ...
              <CheckBox />
              <Text style={{fontWeight: '800', fontSize: 18,marginLeft:10}}>Active</Text>
            </View>
            <View
              style={{flexDirection: 'row', width: '45%', alignItems: 'center'}}>
              <CheckBox />
              <Text style={{fontWeight: '800', fontSize: 18,marginLeft:10}}>In Active</Text>
            </View>
          </View>
  
        <View style={{marginTop:15,marginHorizontal:20}}>
  <Text style={{fontSize:26,fontWeight:'700',color:'#000'}}>Description</Text>
     <Text style={{
      fontWeight:'800',fontSize:20,color:"#000"
     }}>
      cajlkfafldhfhgohogtidrghodglndglgsg,fmnlvknfklgvnkl
     </Text>
        </View>
        </View>
        <View style={{flex: 1, marginHorizontal: 10, marginTop: 20}}>
              ...
              <TouchableOpacity style={styles.card}>
                ...
                <View
                  ...
                  <Text style={{fontSize: 16, fontWeight: '700'}}>
                    Loream Iocn fsadfedfdsf df sdf sdf sdf sd fsd fsd fsd f
                  </Text>
                </View>
              </TouchableOpacity>
            )}
          ...
          {/* <TouchableOpacity
                  style={{backgroundColor: '#032e63',
                  borderRadius:20,alignItems:'center',justifyContent:'center',alignSelf:'center',
                  width: '40%', height: 30}}>
                  <Text
                    style={{fontWeight: 18, color: 'white', fontWeight: '800'}}>
                    View
                  </Text>
                </TouchableOpacity> */}
        </View>
