      ...
      <ScrollView contentContainerStyle={{}}>
        ...
        <View>
          <View style={{marginHorizontal: 15, marginTop: 20}}>
            <Text style={{fontSize: 21, fontWeight: '800', color: '#000'}}>
            Decorative item Details{' '}
              <Text style={{fontSize: 18}}>
                (NON-PRECIOUS ITEM DETAILS USED IN PRODUCT ADDING UP IN GROSS WT.)
              </Text>
            </Text>
          </View>
          ...
          <View style={styles.Card}>
            <View
              ...
              <View
                ...
                <Text style={{fontWeight: '600', fontSize: 18}}>Decorative Item Name</Text>
            ...
            <View
              ...
              <View
                ...
                <Text style={{fontWeight: '600', fontSize: 18}}>Decorative Item Wt.</Text>
                <Text style={{fontWeight: '600', fontSize: 18}}>:</Text>
              </View>
            ...
            <View
              ...
              <View
                ...
                <Text style={{fontWeight: '600', fontSize: 18}}>Unit of Decorative Wt.</Text>
                <Text style={{fontWeight: '600', fontSize: 18}}>:</Text>
              </View>
              <View style={{width: '41.5%'}}>
        ...
        <View>
          <View style={{marginHorizontal: 20, marginTop: 20}}>
            <Text style={{fontSize: 18, fontWeight: '700', color: '#000'}}>
              Decorative item Wt. <Text style={{color: 'red', fontSize: 18}}>*</Text>
            </Text>
            <View>
              <Dropdown
                style={[
        ...
        <TouchableOpacity
          style={styles.addbtn}>
          <Text style={{fontSize: 18, color: 'white'}}>Add  Decorative item Details</Text>
        </TouchableOpacity>
      </ScrollView>
