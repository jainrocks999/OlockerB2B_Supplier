  ...
  return (
    <View style={{flex: 1, backgroundColor: 'white'}}>
      <ScrollView contentContainerStyle={{}}>
          ...
          <View style={{marginHorizontal: 15, marginTop: 20}}>
            <Text style={{fontSize: 22, fontWeight: '800', color: '#000'}}>
              ...
              <Text style={{fontSize: 18}}>
                (DETAILS OF PRECIOUS METAL USED INPRODUCT)
              </Text>
            </Text>
          </View>
          ...
          <View style={styles.Card}>
            <View
              ...
              <View
                ...
                <Text style={{fontWeight: '600', fontSize: 18}}>Metal Wt.</Text>
                <Text style={{fontWeight: '600', fontSize: 18}}>:</Text>
              </View>
              <View>
                <Text style={{fontWeight: '500', fontSize: 18}}> 2.00000</Text>
              </View>
            ...
            <View
              ...
              <View style={{width: '41.5%'}}>
                <Text style={{fontWeight: '500', fontSize: 18}}>999(24K)</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <TouchableOpacity
          style={styles.addbtn}>
          <Text style={{fontSize: 18, color: 'white'}}>Add Metal Details</Text>
        </TouchableOpacity>
      </ScrollView>
