    ...
    <View style={{ flex: 1, backgroundColor: '#fff' }}>
      ...
      <View style={{
       ...
       <View style={{flexDirection:'row',alignItems:'center'}}>
        ...
        <Text style={{color:'#fff',fontSize:16,fontFamily:'Roboto-Medium',marginLeft:14}}>View Collection</Text>
        </View>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
      ...
      <View style={{ paddingHorizontal: 12 }}>
        <View style={{ paddingHorizontal: 11, marginTop: 40 }}>
          <Image style={{ height: 150, width: '100%', borderRadius: 13, }} 
          source={{uri:`https://olocker.co${selector.ImageUrl}${selector.ImageName}`}} />
        </View>
        <View style={{
          width: '100%',
          marginTop: 20,
          ...
          <View style={{ paddingHorizontal: 1, }}>
            <Text style={{ fontFamily: 'Roboto-Medium', fontSize: 16, color: '#000' }}>
             {selector?.Name}
            </Text>
            <Text style={{ fontFamily: 'Roboto-Medium', fontSize: 14, color: '#000', marginTop: 6 }}>
              {selector?.Title}
            </Text>
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 6, marginLeft: -6 }}>
              <RadioButton
                value="first"
                status={active}
                ...
                color='#032e63'
              />
              <Text style={{ color: '#032e63', fontSize: 14, fontFamily: 'Roboto-Medium' }}>{selector.IsActive==0?'In Active':'Active'}</Text>
            </View>
            <View style={{
              flexDirection: 'row',
              justifyContent: 'space-between',
              ...
              <Text style={{ color: '#000', fontSize: 16, fontFamily: 'Roboto-Medium' }}>Description</Text>
            </View>
            <View style={{ marginTop: 10 }}>
              <Text style={{ fontSize: 14, color: '#000', fontFamily: 'Roboto-Regular' }}>{selector?.Description}</Text>
            </View>
          </View>
        ...
        <View style={{
          ...
          <Text style={{ color: '#000', fontSize: 16, fontFamily: 'Roboto-Medium' }}>Product View</Text>
        {selected.length>0? 
        <TouchableOpacity 
        onPress={() => addProduct()}
        style={{
          ...
          justifyContent:'center'
            ...
            <Text style={{color:'#fff',fontFamily:'Roboto-Medium'}}>Add Product</Text>
          ...
          renderItem={({item})=>(
           ...
           {renderCheck(item)}
            ...
            <View style={{marginTop:12,flexDirection:'row',justifyContent:'space-between',alignItems:'center'}}>
              <Text style={{color:'#333333',fontFamily:'Roboto-Medium'}}>{item.Name}</Text>
            ...
            <View style={{marginTop:6,flexDirection:'row',alignItems:'center'}}>
              ...
              <Text style={{color:'#707070',fontFamily:'Roboto-Medium'}}>{`  ${item.Name}`}</Text>
            </View>
